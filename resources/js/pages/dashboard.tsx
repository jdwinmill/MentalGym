...
import { type PracticeMode } from '@/types/training';
import { Head, Link } from '@inertiajs/react';
import { AlertCircle, Dumbbell, Lock, Play, RotateCcw } from 'lucide-react';
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <div>
                    ...
                    <p className="mt-1 text-neutral-500 dark:text-neutral-400">
                        Choose a practice mode to begin your training session
                    </p>
                </div>
