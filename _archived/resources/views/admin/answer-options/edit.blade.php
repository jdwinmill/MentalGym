...
<div class="px-4 sm:px-0">
    ...
    <nav class="mb-4 text-sm">
        <ol class="flex items-center space-x-2 text-gray-500 dark:text-gray-400">
            ...
            <li><span class="mx-2">/</span></li>
            <li class="text-gray-900 dark:text-white font-medium">Edit Answer</li>
        </ol>
    </nav>

    <div class="sm:flex sm:items-center sm:justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Answer Option</h1>
    ...
    <div class="mt-6 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
        <form action="{{ route('admin.answer-options.update', $answerOption) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="option_text" id="option_text" rows="3" required
                              maxlength="500"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('option_text', $answerOption->option_text) }}</textarea>
                    @error('option_text')
                ...
                <div class="flex items-center gap-6">
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" name="is_correct" id="is_correct" value="1"
                               {{ old('is_correct', $answerOption->is_correct) ? 'checked' : '' }}
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order"
                               value="{{ old('sort_order', $answerOption->sort_order) }}"
                               min="1"
